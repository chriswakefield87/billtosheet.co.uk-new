...
export default function BlogPostPage() {
  ...
  return (
    <BlogPostLayout post={post}>
      ...
      <p>Invoice automation might sound a bit complicated, but <strong>it really doesn't have to be</strong>.</p>
      <h3>What is invoice automation?</h3>
      ...
      <div>
        <h3>5 Benefits of Automating Invoice Data Entry</h3>
        <ul>
      ...
      <h3>How to convert invoice PDF to CSV<em><br /></em></h3>
